...
from civic_signal.observability import get_reporter
from civic_signal.performance.benchmark import PerformanceBenchmark
from civic_signal.reports import (
    DiagnosticsReport,
    MethodologySnapshot,
    ModelCard,
    PlotGenerator,
...
class ForecastPipeline:
    ...
    def assess_methodology_readiness(
        ...
        *,
        ...
        from civic_signal.verification import MethodologyReadinessAuditor
    ...
    def run_phase0_spike(
        ...
        self.sync()
        self.build_features()
        from civic_signal.inference.spike import run_phase0_comparison
    ...
    def run_phase0b_spike(self, run_id: str | None = None) -> dict[str, Any]:
        ...
        from civic_signal.inference.acceleration_spike import run_phase0b_acceleration
